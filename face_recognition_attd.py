...
#serialcommunication = serial.Serial('COM5', 9600)  # use your com port
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if (accuracy < 100):
            ...
            lmwriter.writerow([id,current_time])
            #id1="on".strip()
            #serialcommunication.write(id1.encode())
            #time.sleep(0.5)
            ...
            accuracy = "  {0}%".format(round(100 - accuracy))
            #id2="off".strip()
            #serialcommunication.write(id2.encode())
            #time.sleep(0.5)
            #print(serialcommunication.readline().decode('utf-8'))
